...
**Team Members**:  
- Zamrat Zhasulan (`about.html`, `menu.html`)  
...
- **`about.html`** (by Zamrat Zhasulan) — Community workspace concept, accessible laptop environment, and single-origin bean sourcing.
- **`menu.html`** (by Zamrat Zhasulan) — Menu price list with relational data table, milk alternatives nested list, manual pour-over steps, and coffee glossary.
...
- **`task-b-written.md`** — Reflective essays by Zamrat Zhasulan and Zhaksylyk Adilet.
